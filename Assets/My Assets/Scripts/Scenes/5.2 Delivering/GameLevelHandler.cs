...
public class GameLevelHandler : MonoBehaviour
{
    ...
    public GameLevel_En gLevel = new GameLevel_En();
    ...
    public int gLevelId
    {
        get { return m_gLevelId; }
        set { m_gLevelId = value; }
    }
    ...
    void InitLevel()
    {
        gLevelId = controller_Cp.dataManager_Cp.gLevelId;
    }

    void InitUI()
    {
        controller_Cp.ui_Cp.SetGameLevel(gLevelId);
    }
